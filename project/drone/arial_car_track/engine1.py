...
import json
import arial_car_track.count_table
import glob
import arial_car_track.detect_and_track  as detect_and_track
import arial_car_track.detect
...
class Yolo(Engine):
    ...
    def detect_and_track(self):
        ...
        self.save_dir = detect_and_track.run(self.count_boxes,self.loop_boxes,self.time_stamp,self.save_dir,self.names,opt=opt)
        print(self.save_dir)
        print("detect แล้วนะ")
